<template>
  <main class="main">
    <header class="hero">
      <h1 class="hero__title">We choose to go to the moon.</h1>
    ...
    <section class="cards">
      ...
      <article class="card">
        <h1 class="card__title">
          <span>
            <Ellipse variant="no-top-left-quarter" />
          </span>
          Game-changer
        </h1>
        <p class="card__content">
          ...
          their accelerators on the floor.
        </p>
      </article>
      <article class="card">
        <h1 class="card__title">
          <span>
            <Ellipse variant="bottom-half" />
          </span>
          Empower
        </h1>
        <p class="card__content">
